...
export function Home() {
  ...
  const infoBlocks = isMobile ? [ ...InfoBlockStuff, shopInfoBlock ] : InfoBlockStuff;
  ...
  return (
    <Fragment>
      <Section sx={{ flexDirection: "column", alignItems: "center" }}>
        ...
        <Typography variant="h3" marginBottom="24px" textAlign="center" fontSize={isMobile ? "2.4rem" : undefined}>
      ...
      <Section
        sx={{
          ...
          alignItems: "center",
          backgroundColor: palette.grey[200], gap: "16px" }}
        >
        <Grid container alignItems="center" justifyContent="cemter">
          <Grid item xs={12} md={4} display="flex" justifyContent="center" alignItems="center">
            <img src={shopInfoBlock.imgSrc} style={{ width: "80%", margin: "0rem 1rem", borderRadius: "16px" }} />
          </Grid>
      ...
      <Section sx={{ flexDirection: "column", alignItems: "center", gap: "16px", backgroundColor: isMobile ? palette.grey[200] : palette.background.default }}>
